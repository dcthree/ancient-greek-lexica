...
DICTIONARIES = ['aeliusdionysius','hesychius','suda','photios','phrynichus-ecloga','phrynichus-praeparatio','harpokration','synagoge','synagogeb','lsj','logeion','zonaras','haimodein','wip','brill']
HEADWORDS = null
...
generate_link = (dictionary, entry, ref) ->
  url = switch dictionary
    ...
    when 'photios' then "https://dcthree.github.io/photios/entry#urn_cts_greekLit_tlg4040_lexicon_dc3_#{ref}"
